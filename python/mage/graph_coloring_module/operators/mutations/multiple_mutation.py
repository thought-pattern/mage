"""Utilities for multiple mutation."""
...
class MultipleMutation(Mutation):
    ...
    def mutate(
        ...
        nodes = [random_randint(0, len(graph) - 1) for _ in range(no_of_nodes_to_mutate)]
        colors = [random_randint(0, no_of_colors - 1) for _ in range(no_of_nodes_to_mutate)]
